...
import os
import requests
from app.schemas.weather_response import WeatherForecast, CurrentWeather, WeatherResponse
...
def get_weather_tool(
    mode: Literal["current", "forecast", "both"],
    location: Union[str, Literal["Unknown"]], 
    days: Union[int, Literal[0]],
    ) -> WeatherResponse:
    """
