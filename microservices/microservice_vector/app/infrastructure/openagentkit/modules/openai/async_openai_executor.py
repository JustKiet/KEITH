...
from app.infrastructure.openagentkit.core.interfaces.async_base_executor import AsyncBaseExecutor
from app.infrastructure.openagentkit.modules.openai.async_openai_llm_service import AsyncOpenAILLMService
from app.infrastructure.openagentkit.core.models.responses import OpenAgentResponse, OpenAgentStreamingResponse
from app.infrastructure.openagentkit.core.handlers import ToolHandler
...
class AsyncOpenAIExecutor(AsyncBaseExecutor):
    ...
    Example:
    ```python
    from app.infrastructure.openagentkit.modules.openai import AsyncOpenAIExecutor
    from app.infrastructure.openagentkit.tools import duckduckgo_search_tool
    from openai import AsyncOpenAI
