...
from app.infrastructure.openagentkit.core.interfaces.base_llm_model import BaseLLMModel
from app.infrastructure.openagentkit.core.models.responses import (
    OpenAgentResponse, 
    UsageResponse, 
    PromptTokensDetails, 
...
class OpenAILLMService(BaseLLMModel):
    ...
    def model_generate(self, 
        ...
        from app.infrastructure.openagentkit.modules.openai import OpenAILLMService
