...
from app.infrastructure.openagentkit.core.models.responses.usage_responses import UsageResponse

class OpenAgentStreamingResponse(BaseModel):
    """
    The response schema for infrastructure.openagentkit streaming responses.
